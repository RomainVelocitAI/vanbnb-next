  ...
  const fetchVehicles = async () => {
    ...
    try {
      ...
      const transformedVehicles: Vehicle[] = (data || []).map(v => ({
        id: v.id,
        name: v.name || "Van Aménagé",
        type: v.vehicle_type || "van",
        location: v.location || "France",
        price_per_day: v.daily_rate || 100,
        capacity: v.capacity || 2,
        rating: v.average_rating || 4.5,
        reviews_count: v.total_reviews || 0,
        images: v.photos || ["https://images.unsplash.com/photo-1561361513-2d000a50f0dc?w=600"],
        features: v.equipment || [],
